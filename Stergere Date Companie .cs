...
namespace Sebo1
{
    public partial class Stergere_Date_Companie : Form
    {
        string l;
        string p;
        const string quote = "\"";
        public Stergere_Date_Companie()
        {
            InitializeComponent();
        ...
        private void insert_Click(object sender, EventArgs e)
        {
            ...
            sql = "Delete Companie WHERE Id_companie = " + idc + ";";
        ...
        private void refresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlDataAdapter sql = new SqlDataAdapter("SELECT * FROM Companie;", conn);
