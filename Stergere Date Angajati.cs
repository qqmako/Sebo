...
namespace Sebo1
{
    public partial class Stergere_Date_Angajati : Form
    {
        string l;
        string p;
        const string quote = "\"";
        public Stergere_Date_Angajati()
        {
            InitializeComponent();
        ...
        private void insert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                idc = Convert.ToInt32(ida.Text);

                sql = "Delete Angajati WHERE Id_angajat = " + idc + ";";
        ...
        private void refresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlDataAdapter sql = new SqlDataAdapter("SELECT * FROM Angajati;", conn);
