...
namespace Sebo1
{
    public partial class Stergere_Date_Contracte : Form
    {
        string l;
        string p;
        const string quote = "\"";
        public Stergere_Date_Contracte()
        {
            InitializeComponent();
        ...
        private void insert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                idc = Convert.ToInt32(this.idc.Text);

                sql = "Delete Contract WHERE Id_contract = " + idc + ";";
        ...
        private void refresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlDataAdapter sql = new SqlDataAdapter("SELECT * FROM Contract;", conn);
