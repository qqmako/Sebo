...
namespace Sebo1
{
    public partial class Stergere_Date_Oferte : Form
    {
        string l;
        string p;
        const string quote = "\"";
        public Stergere_Date_Oferte()
        {
            InitializeComponent();
        ...
        private void insert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sql = "DELETE Oferte WHERE Id_oferta = " + idc + ";";
        ...
        private void refresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlDataAdapter sql = new SqlDataAdapter("SELECT * FROM Oferte;", conn);
