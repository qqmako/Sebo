...
namespace Sebo1
{
    public partial class Stergere_Date_Clienti : Form
    {
        string l;
        string p;
        const string quote = "\"";
        public Stergere_Date_Clienti()
        {
            InitializeComponent();
        ...
        private void insert_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sql = "Delete Client WHERE Id_client = " + idc + ";";
        ...
        private void refresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlDataAdapter sql = new SqlDataAdapter("SELECT * FROM Client;", conn);
